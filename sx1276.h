 ...
 * 
 * @version 1.0
 * @see Este código está basado en el programa de prueba disponible en Github al que se hace referencia en la memoria del proyecto.
 * 
 * Esta es una nueva versión del módulo del mismo nombre disponible en Github
 * @see referencia a programa de prueba
 * 
 * Esta versión incorpora algunas modificaciones que se explican en la memoria del
 * proyecto. Tanto en su versión original como en esta nueva versión, el módulo
 * sx1276 disponibiliza múltiples funciones, utilizadas por el módulo radio.
 * Estas funciones permiten inicializar la radio, resetearla por software, realizar
 * las configuraciones para el funcionamiento de la radio en modo recepción y
 * transmisión, y llenar una FIFO con los datos para trasmitir a través del enlace
 * 
 * @version 2.0
